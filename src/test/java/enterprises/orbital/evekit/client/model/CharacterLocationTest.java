...
/**
 * Model tests for CharacterLocation
 */
public class CharacterLocationTest {
    private final CharacterLocation model = new CharacterLocation();
