...
public class CharacterApiTest {
    ...
    public void getCharacterSheetsTest() throws ApiException {
        ...
        String title = null;
        List<CharacterSheet> response = api.getCharacterSheets(accessKey, accessCred, at, contid, maxresults, reverse, characterID, name, corporationID, raceID, doB, bloodlineID, ancestryID, gender, allianceID, factionID, description, securityStatus, title);
